const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./_virtual_cosmos-imports-4vYo9Oxw.js","./_virtual_cosmos-imports-DSVx0aYG.css"])))=>i.map(i=>d[i]);
...
async function mount() {
  const args = await __vitePreload(() => import("./_virtual_cosmos-imports-4vYo9Oxw.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url);
